...
public class UserInfoController {
    ...
    @GetMapping
    ResponseEntity<EntityWithPagination> getAllUserInfosWithPagination(@RequestParam @Valid @Positive(message = "validation.positive") int pageNumber, @RequestParam @Valid @Positive(message = "validation.positive") int pageSize) {
